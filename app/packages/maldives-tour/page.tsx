...
const maldivesPackages = [
  {
    title: "Overwater Villa Romantic Escape",
    duration: "5 Days / 4 Nights",
    price: "AED 5,999",
    oldPrice: "AED 7,200",
    description: "Indulge in pure luxury with a private overwater villa, private pool, champagne breakfast, and candlelit dinners on the beach.",
    rating: "5.0",
    inclusions: ["Luxury Overwater Villa Stay", "Half Board Meals", "Return Speedboat Transfers", "Floating Breakfast", "Sunset Dolphin Cruise"]
  },
  {
    title: "Family Beachfront Oasis Resort",
    duration: "6 Days / 5 Nights",
    price: "AED 4,499",
    oldPrice: "AED 5,500",
    description: "Perfect for families. Enjoy a spacious beach bungalow steps away from the turquoise ocean, kids club activities, and water slides.",
    rating: "4.9",
    inclusions: ["Beachfront Family Villa Stay", "All Inclusive Meals", "Return Speedboat Transfers", "Kids Club Access", "Complimentary Snorkeling Tours"]
  },
  {
    title: "Adventure & Island Explorer Tour",
    duration: "5 Days / 4 Nights",
    price: "AED 3,299",
    oldPrice: "AED 4,000",
    description: "An action-packed itinerary featuring daily snorkeling safaris, local island hopping, sandbank picnics, and scuba diving guidance.",
    rating: "4.8",
    inclusions: ["Premium Beachfront Villa Stay", "Breakfast & Lunch", "Speedboat Transfers", "Guided Scuba Diving Session", "Sandbank BBQ Lunch"]
  }
];

export default function MaldivesTourPage() {
  const [formData, setFormData] = useState({
    ...
    travelDate: "",
    travelers: "1",
    packageType: maldivesPackages[0].title,
    message: ""
  });
  ...
  const handleInquirySubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await addDoc(collection(db, "leads"), {
        ...
        visaType: "Maldives Tour Booking",
  ...
  return (
    <main className="bg-[#071120] text-white min-h-screen">
      ...
      <section className="relative h-[65vh] w-full flex items-center justify-center overflow-hidden pt-20">
        <Image
          src="https://images.unsplash.com/photo-1573843981267-be1999ff37cd?q=80&w=1800"
          alt="Maldives"
          fill
          priority
        ...
        <div className="relative z-10 text-center max-w-4xl px-6">
          ...
          <p className="mt-6 text-lg md:text-xl text-gray-200 drop-shadow-lg leading-relaxed max-w-2xl mx-auto">
            Escape to white sandy beaches, crystal-clear turquoise lagoons, and unmatched overwater villa experiences. Select your dream Maldives holiday today.
          </p>
        </div>
      </section>
      ...
      <section className="max-w-7xl mx-auto px-6 py-20">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-5xl font-bold">Choose Your Dream Escape</h2>
          <p className="mt-4 text-gray-400 max-w-xl mx-auto">Browse our curated packages tailored for couples, families, and adventure seekers.</p>
        </div>
            ...
            >
              ...
              <div className="border-t border-white/10 pt-6 mt-auto">
                ...
                <div className="flex flex-col gap-2.5">
                  ...
                  <a 
                    href={`https://wa.me/971501234567?text=Hi%20Eshaare%2C%20I%20want%20to%20know%20more%20about%20your%20Maldives%20${encodeURIComponent(pkg.title)}.`}
                    target="_blank"
      ...
      <section id="inquiry-section" className="bg-[#0b1425] border-t border-b border-white/10 py-24">
        <div className="max-w-4xl mx-auto px-6">
          <div className="text-center mb-14">
            ...
            <p className="mt-4 text-gray-400">Tell us your preferences and our Maldives vacation planner will structure the perfect itinerary for you.</p>
          </div>
          ...
          {submitted ? (
            ...
            <form onSubmit={handleInquirySubmit} className="space-y-6 bg-white/5 border border-white/10 p-8 md:p-12 rounded-[40px] backdrop-blur-2xl">
              ...
              <div className="flex flex-col gap-2">
                ...
                <textarea
                  name="message"
                  placeholder="E.g. Honeymoon inclusions, beach dinner, vegetarian meals, flight bookings included..."
