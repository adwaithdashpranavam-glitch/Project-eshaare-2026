...
const switzerlandPackages = [
  {
    title: "Swiss Alps & Peaks Experience",
    duration: "8 Days / 7 Nights",
    price: "AED 7,999",
    oldPrice: "AED 8,999",
    description: "Explore Switzerland's snow-capped peaks. Take a cable car to Mount Titlis, ride the scenic Glacier Express, and wander the charming streets of Lucerne and Interlaken.",
    rating: "5.0",
    inclusions: ["Chalet-style Boutique Stays", "Swiss Travel Pass (8 Days)", "Glacier Express Train Booking", "Mount Titlis Cable Car Ticket", "Daily Alpine Buffet Breakfast"]
  },
  {
    title: "Swiss Lakes & Scenic Cities Panorama",
    duration: "7 Days / 6 Nights",
    price: "AED 6,999",
    oldPrice: "AED 7,800",
    description: "Journey through Switzerland's postcard-perfect lakeside towns. Enjoy boat cruises on Lake Geneva, chocolate tours in Zurich, and castle visits in Montreux.",
    rating: "4.9",
    inclusions: ["Luxury City Center Hotels", "Lake Geneva Scenic Cruise Ticket", "Lindt Home of Chocolate Entry VIP Pass", "Swiss Travel Pass (3-class)", "Return Airport Transfers"]
  },
  {
    title: "Alpine Honeymoon & Spa Retreat",
    duration: "6 Days / 5 Nights",
    price: "AED 9,999",
    oldPrice: "AED 11,200",
    description: "A dream honeymoon in Zermatt facing the Matterhorn. Includes a private thermal spa retreat, scenic helicopter flight, and gourmet candlelit mountain dinners.",
    rating: "5.0",
    inclusions: ["5-star Matterhorn View Suite Stay", "Private Couple's Spa Therapy Session", "Matterhorn Helicopter Sightseeing Tour", "Daily Champagne Breakfast & Dinners", "Private Taxi Transfers"]
  }
];

export default function SwitzerlandTourPage() {
  const [formData, setFormData] = useState({
    ...
    travelDate: "",
    travelers: "1",
    packageType: switzerlandPackages[0].title,
    message: ""
  });
  ...
  const handleInquirySubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await addDoc(collection(db, "leads"), {
        ...
        visaType: "Switzerland Tour Booking",
    ...
    <main className="bg-[#071120] text-white min-h-screen">
      ...
      <section className="relative h-[65vh] w-full flex items-center justify-center overflow-hidden pt-20">
        ...
        <div className="relative z-10 text-center max-w-4xl px-6">
          ...
          <p className="mt-6 text-lg md:text-xl text-gray-200 drop-shadow-lg leading-relaxed max-w-2xl mx-auto">
            Journey to postcard-perfect lakes, snow-capped peaks, and premium alpine resorts. Experience the ultimate Swiss escape.
          </p>
        </div>
      </section>
      ...
      <section className="max-w-7xl mx-auto px-6 py-20">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-5xl font-bold">Explore Alpine Elegance</h2>
          <p className="mt-4 text-gray-400 max-w-xl mx-auto">Browse our ultra-luxury, high-end Swiss vacations structured for a pristine Europe holiday experience.</p>
        </div>

        {/* PACKAGE CARDS GRID */}
        <div className="grid gap-8 lg:grid-cols-3">
          {switzerlandPackages.map((pkg, idx) => (
            <div 
              key={idx}
            ...
            >
              ...
              <div className="border-t border-white/10 pt-6 mt-auto">
                ...
                <div className="flex flex-col gap-2.5">
                  ...
                  <a 
                    href={`https://wa.me/971501234567?text=Hi%20Eshaare%2C%20I%20want%20to%20know%20more%20about%20your%20Switzerland%20${encodeURIComponent(pkg.title)}.`}
                    target="_blank"
      ...
      <section id="inquiry-section" className="bg-[#0b1425] border-t border-b border-white/10 py-24">
        <div className="max-w-4xl mx-auto px-6">
          <div className="text-center mb-14">
            ...
            <p className="mt-4 text-gray-400">Tell us your preferences and our Swiss travel specialists will structure the ideal itinerary for you.</p>
          </div>
          ...
          {submitted ? (
            ...
            <form onSubmit={handleInquirySubmit} className="space-y-6 bg-white/5 border border-white/10 p-8 md:p-12 rounded-[40px] backdrop-blur-2xl">
              ...
              <div className="flex flex-col gap-2">
                ...
                <textarea
                  name="message"
                  placeholder="E.g. Train passes details, mountain excursions, flight tickets, hotel star preference, Schengen visa assistance details..."
