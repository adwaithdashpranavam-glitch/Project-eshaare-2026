...
const thailandPackages = [
  {
    title: "Phuket & Krabi Island Explorer",
    duration: "6 Days / 5 Nights",
    price: "AED 2,499",
    oldPrice: "AED 3,200",
    description: "Discover beautiful southern islands. Includes luxury beach resort stays, Phi Phi island cruise, sea kayaking, and snorkeling in crystal waters.",
    rating: "4.9",
    inclusions: ["4-star Resort Stays", "Phi Phi Island Day Tour by Speedboat", "Daily Breakfast Buffets", "Return Airport Transfers", "Professional Local Tour Guide"]
  },
  {
    title: "Bangkok & Pattaya City & Culture Tour",
    duration: "5 Days / 4 Nights",
    price: "AED 1,999",
    oldPrice: "AED 2,600",
    description: "Immerse in the energy of Bangkok and beaches of Pattaya. Tour the Grand Palace, floating market, and enjoy premium cabarets and nightlife.",
    rating: "4.8",
    inclusions: ["City Hotel Stays", "Grand Palace & Temple Tour", "Daily Breakfast", "Floating Market Scenic Boat Tour", "Return Airport Transfers"]
  },
  {
    title: "Chiang Mai & Northern Nature Sanctuary",
    duration: "6 Days / 5 Nights",
    price: "AED 2,299",
    oldPrice: "AED 2,900",
    description: "Journey to the cultural heart of northern Thailand. Visit ethical elephant sanctuaries, grand mountain temples, and join local cooking masterclasses.",
    rating: "4.8",
    inclusions: ["Lanna Heritage Hotel Stay", "Ethical Elephant Sanctuary Day Visit", "Daily Breakfast & Lunch", "Doi Suthep Mountain Tour", "Traditional Thai Cooking Class"]
  }
];
...
export default function ThailandTourPage() {
  const [formData, setFormData] = useState({
    ...
    travelDate: "",
    travelers: "1",
    packageType: thailandPackages[0].title,
    message: ""
  });
  ...
  const handleInquirySubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await addDoc(collection(db, "leads"), {
        ...
        visaType: "Thailand Tour Booking",
    ...
    <main className="bg-[#071120] text-white min-h-screen">
      ...
      <section className="relative h-[65vh] w-full flex items-center justify-center overflow-hidden pt-20">
        ...
        <div className="relative z-10 text-center max-w-4xl px-6">
          ...
          <p className="mt-6 text-lg md:text-xl text-gray-200 drop-shadow-lg leading-relaxed max-w-2xl mx-auto">
            Experience lively street life, sacred golden temples, and spectacular tropical beaches. Select your perfect Thailand adventure today.
          </p>
        </div>
      </section>
      ...
      <section className="max-w-7xl mx-auto px-6 py-20">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-5xl font-bold">Discover Thai Wonders</h2>
          <p className="mt-4 text-gray-400 max-w-xl mx-auto">Browse our budget-friendly and custom curated packages for an unforgettable Thailand getaway.</p>
        </div>
            ...
            >
              ...
              <div className="border-t border-white/10 pt-6 mt-auto">
                ...
                <div className="flex flex-col gap-2.5">
                  ...
                  <a 
                    href={`https://wa.me/971501234567?text=Hi%20Eshaare%2C%20I%20want%20to%20know%20more%20about%20your%20Thailand%20${encodeURIComponent(pkg.title)}.`}
                    target="_blank"
      ...
      <section id="inquiry-section" className="bg-[#0b1425] border-t border-b border-white/10 py-24">
        <div className="max-w-4xl mx-auto px-6">
          <div className="text-center mb-14">
            ...
            <p className="mt-4 text-gray-400">Tell us your preferences and our Thailand travel specialists will structure the ideal itinerary for you.</p>
          </div>
          ...
          {submitted ? (
            ...
            <form onSubmit={handleInquirySubmit} className="space-y-6 bg-white/5 border border-white/10 p-8 md:p-12 rounded-[40px] backdrop-blur-2xl">
              ...
              <div className="flex flex-col gap-2">
                ...
                <textarea
                  name="message"
                  placeholder="E.g. Snorkeling details, private transfer options, hotel star level, vegan meal options..."
